...
ENV["JULIA_DEBUG"] = "Documenter,Literate,RBMsAnnealedImportanceSampling"
...
# Build docs
Documenter.makedocs(
    modules = [RBMsAnnealedImportanceSampling],
    sitename = "RBMsAnnealedImportanceSampling.jl",
    pages = [
        "Home" => "index.md",
        "Examples" => [
            "AIS" => "literate/ais.md",
...
Documenter.deploydocs(
    repo = "github.com/cossio/RBMsAnnealedImportanceSampling.jl.git",
    devbranch = "master"
)
